...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UchPlanHour.type_hour'
        db.add_column('uch_plan_hour', 'type_hour', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tariffication.TypeHour']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UchPlanHour.type_hour'
        db.delete_column('uch_plan_hour', 'type_hour_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 13, 21, 18, 45, 387371)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 13, 21, 18, 45, 387258)'}),
