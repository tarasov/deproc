...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UchPlanHour.type'
        db.delete_column('uch_plan_hour', 'type')


    def backwards(self, orm):
        
        # Adding field 'UchPlanHour.type'
        db.add_column('uch_plan_hour', 'type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 42, 18, 774320)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 42, 18, 774198)'}),
