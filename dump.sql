...
INSERT INTO `typehour` VALUES (1,'Ð›ÐµÐºÑ†Ð¸Ñ','Ð»Ðº'),(2,'ÐŸÑ€Ð°ÐºÑ‚Ð¸ÐºÐ°','Ð¿Ðº'),(3,'ÐšÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†','ÐºÐ½'),(4,'Ð­ÐºÐ·Ð°Ð¼ÐµÐ½','ÑÐº'),(5,'ÐšÑƒÑ€ÑÐ¾Ð²Ð¾Ðµ Ð¿Ñ','ÐºÐ¿'),(6,'ÐŸÑ€Ð¾Ð²ÐµÑ€ÐºÐ° ÐºÑ','Ð¿Ðº');
...
-- Dump completed on 2012-05-14  1:36:19
