...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 15, 47, 3, 376110)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 15, 47, 3, 375991)'}),
        ...
        'tariffication.students': {
            ...
            'elder': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
