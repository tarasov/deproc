...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Journal_day'
        db.delete_table('journal_day')

        # Adding model 'Theme_of_day'
        ...
        db.send_create_signal('journal', ['Theme_of_day'])


    def backwards(self, orm):
        
        # Adding model 'Journal_day'
        db.create_table('journal_day', (
            ('describe', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('day', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Schedule_day'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('journal', ['Journal_day'])

        # Deleting model 'Theme_of_day'
        db.delete_table('journal_day')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 9, 15, 50, 11, 964553)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 9, 15, 50, 11, 964427)'}),
