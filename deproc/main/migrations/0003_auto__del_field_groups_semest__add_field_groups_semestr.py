...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Groups.semest'
        db.delete_column('main_groups', 'semest')

        # Adding field 'Groups.semestr'
        db.add_column('main_groups', 'semestr',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Groups.semest'
        db.add_column('main_groups', 'semest',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Groups.semestr'
        db.delete_column('main_groups', 'semestr')
    ...
    models = {
        ...
        'main.groups': {
            ...
            'semestr': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
