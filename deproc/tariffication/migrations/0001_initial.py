...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('tariffication', ['Classroom'])
        ...
        db.create_table('teachers', (
            ('profile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tariffication.Profile'], unique=True, primary_key=True)),
            ('cabinet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tariffication.Classroom'], null=True, blank=True)),
        ))
        ...
        # Adding model 'TypeHour'
        db.create_table('typehour', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=6)),
        ))
        db.send_create_signal('tariffication', ['TypeHour'])
        ...
        db.create_table('uch_plan_hour', (
            ...
            ('type_hour', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tariffication.TypeHour'])),
        ...
        # Adding M2M table for field student on 'Groups_stud'
        db.create_table('groups_stud_student', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groups_stud', models.ForeignKey(orm['tariffication.groups_stud'], null=False)),
            ('students', models.ForeignKey(orm['tariffication.students'], null=False))
        ))
        db.create_unique('groups_stud_student', ['groups_stud_id', 'students_id'])
        ...
        db.create_table('tariffication', (
            ...
            ('group_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gpset', to=orm['tariffication.Groups_plan'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TypeHour'
        db.delete_table('typehour')
        ...
        # Removing M2M table for field student on 'Groups_stud'
        db.delete_table('groups_stud_student')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 41, 59, 682911)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 41, 59, 682798)'}),
