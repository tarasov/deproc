...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schedule.count_hours'
        db.add_column('schedule', 'count_hours', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schedule.count_hours'
        db.delete_column('schedule', 'count_hours')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 23, 19, 571900)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 12, 23, 19, 571740)'}),
        ...
        'schedule.schedule': {
            ...
            'count_hours': ('django.db.models.fields.IntegerField', [], {}),
