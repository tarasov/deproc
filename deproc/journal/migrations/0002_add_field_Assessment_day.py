...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 7, 23, 58, 19, 947489)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 7, 23, 58, 19, 947280)'}),
        ...
        'journal.assessment': {
            ...
            'day': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['journal.Journal_day']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
